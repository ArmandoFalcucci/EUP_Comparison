...
This is an R Markdown document containing the Rcode and workflow for the Tracking the emergence of the Upper Palaeolithic in western Asia and Europe: a Multiple Correspondence Analysis of Protoaurignacian and southern Ahmarian lithics article. This section is dedicated to exploratory plots
...
#mode
# Create bins of 1 mm width and count how many Width values fall in each bin per Site_F
binned_freq <- balanced_data %>%
  mutate(Bin = cut(Width, breaks = seq(floor(min(Width, na.rm = TRUE)),
                                       ceiling(max(Width, na.rm = TRUE)),
                                       by = 1),
