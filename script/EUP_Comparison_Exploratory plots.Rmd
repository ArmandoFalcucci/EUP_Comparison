...
Gen.Profile <- grouped_ggbarstats(
  data = filter(Blanks_Main_merged, Blank.type2_F !="Flake", Profile_F !="ND"), 
  x = Profile_F,  
  y = Site_F, 
  xlab = "Site",
  grouping.var = Blank.type2_F,
...
Length <- grouped_ggbetweenstats(
  data = filter(Blanks_Main_merged, Blank.type2_F != "Flake", Preservation == "Complete", Length !="NA", Tool != "Yes"),
  x = Site_F,     
  y = Length, 
  grouping.var = Blank.type2_F,
  xlab = "Site",
...
Width <- grouped_ggbetweenstats(
  data = filter(Blanks_Main_merged, Blank.type2_F != "Flake", Width !="NA", Tool != "Yes"),
  x = Site_F,     
  y = Width, 
  grouping.var = Blank.type2_F,
  xlab = "Site",
...
Thickness <- grouped_ggbetweenstats(
  data = filter(Blanks_Main_merged, Blank.type2_F != "Flake", Thickness !="NA", Tool != "Yes" ),
  x = Site_F,     
  y = Thickness, 
  grouping.var = Blank.type2_F,
  xlab = "Site",
...
balanced_data <- filtered_data %>%
  ...
  ungroup() %>%
  select(-samples_needed)  # Remove the helper column
